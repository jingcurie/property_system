 <!-- 搜索栏 -->
 <div class="sticky-top bg-white" style="top: 0px; z-index: 1;"> {{-- 新增 sticky --}}
                         ...
                         <td>
                             ...
                             @switch($type)
                                 ...
                                 @default
                                     @if (isset($col['link']))
                                         @php
                                             $link = is_callable($col['link']) ? $col['link']($item) : $col['link'];
                                         @endphp
                                         <a href="{{ $link }}">
                                             {{ $value }}
                                         </a>
                                                 ...
                                                 <a class="dropdown-item {{ $action['class'] ?? '' }}"
                                                     ...
                                                     @if (isset($action['data']))
                                                         @foreach ($action['data'] as $key => $value)
                                                             data-{{ $key }}="{{ is_callable($value) ? $value($item) : $value }}"
                                                         @endforeach
                                                     @endif
 ...
 <div class="card-footer bg-white border-0 py-1">
     {{-- @if ($paginator instanceof \Illuminate\Pagination\LengthAwarePaginator && $paginator->perPage() < $paginator->total()) --}}
