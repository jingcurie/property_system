...
<body>
    <div class="d-flex">
        <div id="sidebar" class="sidebar d-flex flex-column">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                    <a href="{{ route('dashboard') }}" class="nav-link" onclick="handleMainMenuClick(this)">
                ...
                <li class="nav-item has-submenu {{ request()->routeIs('properties.*') ? 'active' : '' }}">
                    ...
                    <div class="submenu">
                        <a href="{{ route('properties.index') }}" class="submenu-item {{ request()->routeIs('properties.index') ? 'active' : '' }}" onclick="handleSubmenuClick(this)">
                    ...
                    <div class="floating-menu">
                        <a href="{{ route('properties.index') }}" class="submenu-item" onclick="handleFloatingMenuClick(this)">
                            <i class="bi bi-house-check"></i> {{ __('menu.properties') }}
                        </a>
                ...
                <li class="nav-item has-submenu {{ request()->routeIs('rental_applications.*') ? 'active' : '' }}">
                    ...
                    <div class="submenu">
                        <a href="{{ route('rental_applications.index') }}" class="submenu-item {{ request()->routeIs('rental_applications.index') ? 'active' : '' }}" onclick="handleSubmenuClick(this)">
                    ...
                    <div class="floating-menu">
                        <a href="{{ route('rental_applications.index') }}" class="submenu-item" onclick="handleFloatingMenuClick(this)">
                            <i class="bi bi-clipboard-check"></i> {{ __('menu.applications') }}
                        </a>
                        <a href="#" class="submenu-item" onclick="handleFloatingMenuClick(this)">
                            <i class="bi bi-person-lines-fill"></i> {{ __('menu.applicants') }}
                ...
                <li class="nav-item {{ request()->routeIs('file-center.*') ? 'active' : '' }}">
                    <a href="{{ route('file-center.index') }}" class="nav-link" onclick="handleMainMenuClick(this)">
                        <div class="nav-link-content">
                ...
                {{-- User --}}
                <li class="nav-item has-submenu {{ request()->routeIs(['users.*', 'roles.*', 'permissions.*']) ? 'active' : '' }}">
                    <a href="javascript:void(0)" class="nav-link" onclick="toggleSubmenu(this)">
                        <div class="nav-link-content">
                    ...
                    <div class="submenu">
                        <a href="{{ route('users.index') }}" class="submenu-item {{ request()->routeIs('users.*') ? 'active' : '' }}" onclick="handleSubmenuClick(this)">
                            <i class="bi bi-people"></i> {{ __('menu.users') }}
                        </a>
                        <a href="{{ route('roles.index') }}" class="submenu-item {{ request()->routeIs('roles.*') ? 'active' : '' }}" onclick="handleSubmenuClick(this)">
                            <i class="bi bi-person-gear"></i> {{ __('menu.roles') }}
                        </a>
                        <a href="{{ route('permissions.index') }}" class="submenu-item {{ request()->routeIs('permissions.*') ? 'active' : '' }}" onclick="handleSubmenuClick(this)">
                            <i class="bi bi-shield-lock"></i> {{ __('menu.permissions') }}
                        </a>
                    </div>
                    <div class="floating-menu">
                        <a href="{{ route('users.index') }}" class="submenu-item" onclick="handleFloatingMenuClick(this)">
                            <i class="bi bi-people"></i> {{ __('menu.users') }}
                        </a>
                        <a href="{{ route('roles.index') }}" class="submenu-item" onclick="handleFloatingMenuClick(this)">
                            <i class="bi bi-person-gear"></i> {{ __('menu.roles') }}
                        </a>
                        <a href="{{ route('permissions.index') }}" class="submenu-item" onclick="handleFloatingMenuClick(this)">
                            <i class="bi bi-shield-lock"></i> {{ __('menu.permissions') }}
                        </a>
                    </div>
                </li>
        ...
        <div id="main-content" class="main-content flex-grow-1">
            <!-- 美化后的顶部导航栏 -->
            <nav class="navbar navbar-expand navbar-light bg-white border-bottom shadow-sm w-100 d-flex justify-content-between align-items-center px-4 py-2">
                <!-- 左侧欢迎区域 -->
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light rounded-pill px-3 py-1 border-0 shadow-sm dropdown-toggle" 
                            ...
                            {{ app()->getLocale() === 'zh-CN' ? '中文' : 'English' }}
                        </button>
                    ...
                    <!-- 用户头像与名称 -->
                    <div class="dropdown">
                        <button class="btn btn-light rounded-pill d-flex align-items-center px-3 py-1 border-0 shadow-sm dropdown-toggle" 
                                type="button" data-bs-toggle="dropdown">
        ...
        <div class="notification-list">
            <div class="notification-item unread">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <div class="fw-medium">{{ __('layout.new_rental_application') }}</div>
                        <div class="text-muted small">{{ __('layout.notification_sample_1') }}</div>
                    </div>
                </div>
            </div>
            <div class="notification-item">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <div class="fw-medium">{{ __('layout.system_backup_completed') }}</div>
                        <div class="text-muted small">{{ __('layout.notification_sample_2') }}</div>
                    </div>
                </div>
            </div>
            <div class="notification-item">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <div class="fw-medium">{{ __('layout.maintenance_reminder') }}</div>
                        <div class="text-muted small">{{ __('layout.notification_sample_3') }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function restoreMenuState() {
            ...
            if (expandedMenu && activeSubmenu) {
                // 恢复展开的子菜单和高亮的子菜单项
                document.querySelectorAll('.nav-item').forEach(item => {
                    const menuText = item.querySelector('.nav-link span')?.textContent;
