...
@section('content')
    <div class="container-fluid px-0">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="fw-bold text-dark"><i class="bi bi-houses-fill"></i> 房源管理</h2>
        ...
        <div class="card shadow-sm">
            <form method="GET" action="{{ route('properties.index') }}" id="filter-form" class="mb-1">
                {{-- <div class="card border-0 shadow-sm"> --}}
                            ...
                            <ul class="dropdown-menu" aria-labelledby="filterDropdown" id="filter-menu">
                                <li class="px-3 py-1">
                                    <div class="form-check">
                                        <input class="form-check-input filter-checkbox" type="checkbox" value="rent"
                                            id="filter-rent">
                                        <label class="form-check-label" for="filter-rent">租金</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input filter-checkbox" type="checkbox" value="city"
                                            id="filter-city">
                                        <label class="form-check-label" for="filter-city">城市</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input filter-checkbox" type="checkbox" value="type"
                                            id="filter-type">
                                        <label class="form-check-label" for="filter-type">房源类型</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input filter-checkbox" type="checkbox" value="owner_id"
                                            id="filter-owner">
                            ...
                            @if (request('filters'))
                                @foreach (request('filters') as $filter)
                                    <div class="col-md-auto">
                                        @include('properties.partials.filter_fields', [
                                            'filter' => $filter,
                    ...
                    <div class="card-footer bg-white" id="filter-action-bar" style="display: none; text-align:right;">
                        ...
                        <a href="{{ route('properties.index') }}" class="btn btn-secondary"><i class="bi bi-x-circle"></i>
                            重置</a>
                    </div>
                {{-- </div> --}}
            </form>
            <div class="table-responsive">
                ...
                @endif
                <form id="batch-delete-form" method="POST" action="{{ route('properties.batchDelete') }}"
                            ...
                            <tr>
                                ...
                                <th>
                                    <a href="{{ request()->fullUrlWithQuery(['sort' => $sortField, 'direction' => $dir]) }}"
                                        ...
                                        <a href="{{ route('properties.index') }}" class="ms-1 text-muted"
                                            title="恢复默认顺序">
                            ...
                            @forelse ($properties as $property)
                                <tr>
                                    <td><input type="checkbox" name="selected_ids[]"
                                            value="{{ $property->property_id }}" class="form-check-input"></td>
                                    <td>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('properties.show', $property->property_id) }}">
                                                        <i class="bi bi-eye me-2"></i> 查看
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('properties.edit', $property->property_id) }}">
