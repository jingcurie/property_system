...
@section('content')
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                @if ($applicant)
                    ...
                    <p><strong>地址：</strong> {{ $applicant->address_line1 }} {{ $applicant->address_line2 }},
        ...
        @include('components.files.upload', [
            ...
            'fileable_type' => $rentalApplication ? get_class($rentalApplication) : App\Models\RentalApplication::class,
